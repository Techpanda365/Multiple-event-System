...
export function EditItemClient({ productId }: { productId: string }) {
  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        const [productRes, taxesRes, catsRes, whRes] = await Promise.all([
        ...
        setForm({
          ...
          purchasePrice: product.cost != null ? String(product.cost) : "",
          quantity: String(product.stock ?? 1),
          productImage: product.image || "",
          additionalImages: additional,
          warehouseId: product.warehouseId || "",
          reorderLevel: product.reorderLevel != null ? String(product.reorderLevel) : "",
          maxLevel: product.maxLevel != null ? String(product.maxLevel) : "",
          valuationMethod: product.valuationMethod || "Weighted Average",
      ...
      <div className="max-w-3xl mx-auto space-y-5 pb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Update product or service details</p>
          </div>
        </div>
