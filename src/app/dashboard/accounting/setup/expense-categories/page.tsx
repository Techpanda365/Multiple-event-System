...
export default function ExpenseCategoriesPage() {
  ...
  const [selectedItem, setSelectedItem] = useState<ExpenseCategory | null>(null);
  ...
  const fetchCategories = async () => {
    try {
      setLoading(true);
      const res = await fetch('/api/accounting/setup?type=expenseCategory');
  ...
  const handleView = (item: ExpenseCategory) => {
  ...
  return (
    <div className="p-6 bg-gray-900 min-h-screen">
      <div className="flex items-center gap-2 text-sm text-gray-400 mb-4">
        ...
        <span className="text-white">Expense Categories</span>
      </div>

      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-semibold text-white">Expense Categories</h1>
          <p className="text-sm text-gray-400 mt-1">Manage expense categories</p>
        </div>
        <Link href="/dashboard/accounting/setup/expense-categories/create">
      ...
      <div className="flex gap-1 bg-gray-800 rounded-lg border border-gray-700 p-1 mb-6">
        ...
        <button className="px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium">Expense Categories</button>
      </div>
        ...
        <div className="flex flex-wrap items-center gap-4">
          <div className="flex-1 min-w-[200px]">
            <div className="relative">
              ...
              <input type="text" placeholder="Search expense categories..."
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-700">
              {loading ? (
                ...
                <tr><td colSpan={6} className="px-4 py-12 text-center text-gray-500">No expense categories found</td></tr>
              ) : (
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 rounded-lg border border-gray-700 max-w-md w-full p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-white">Expense Category Details</h2>
      ...
      {showEditModal && editFormData && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 rounded-lg border border-gray-700 max-w-md w-full p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-white">Edit Expense Category</h2>
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 rounded-lg border border-gray-700 max-w-md w-full p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl font-semibold text-white">Delete Expense Category</h2>
            </div>
            <p className="text-gray-400 mb-2">Are you sure you want to delete this expense category?</p>
